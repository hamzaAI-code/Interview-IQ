...
def render_setup() -> None:
    ...
    st.caption(
        "Upload a resume and paste a JD. The system extracts both into a Neo4j knowledge "
        "graph, ranks technical topics by JD priority × resume evidence, and runs a focused "
        "topic-by-topic interview with follow-ups on contradictions."
    )
